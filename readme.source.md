...
<SocialMediaButton
  ...
  height={44}
  gradientStops={[
    { offset: '0%', color: '#b57af9' }, { offset: '30%', color: '#000000' }, { offset: '60%', color: '#9d6bf0' }, { offset: '80%', color: '#000000' }, { offset: '100%', color: '#c89dfb' }
  ]}
/>
```
...
<SocialMediaButton
  ...
  height={44}
  gradientStops={[
    { offset: '0%', color: '#818cf8' }, { offset: '30%', color: '#000000' }, { offset: '60%', color: '#9298f8' }, { offset: '80%', color: '#000000' }, { offset: '100%', color: '#7479f5' }
  ]}
/>
```
...
<SocialMediaButton
  ...
  height={44}
  gradientStops={[
    { offset: '0%', color: '#d855f7' }, { offset: '30%', color: '#000000' }, { offset: '60%', color: '#b557e8' }, { offset: '80%', color: '#000000' }, { offset: '100%', color: '#cc6ef9' }
  ]}
/>
```
...
<div style={{ width: '100%', height: '100%', background: '#08080c', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative', overflow: 'hidden', borderRadius: 12, border: '1px solid rgba(110,80,220,0.2)' }}>
  ...
  <div id="title" style={{ color: '#fff', fontFamily: 'Inter', fontSize: 26, fontWeight: 700, letterSpacing: '3px', margin: 0, display: 'flex' }}>ABOUT ME</div>
</div>
```
...
<div style={{ width: '100%', height: '100%', background: '#08080c', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative', overflow: 'hidden', borderRadius: 12, border: '1px solid rgba(110,80,220,0.2)' }}>
  ...
  <div id="title2" style={{ color: '#fff', fontFamily: 'Inter', fontSize: 26, fontWeight: 700, letterSpacing: '3px', margin: 0, display: 'flex' }}>FEATURED PROJECTS</div>
</div>
```
...
<div style={{ width: '100%', height: '100%', background: '#08080c', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative', overflow: 'hidden', borderRadius: 12, border: '1px solid rgba(110,80,220,0.2)' }}>
  ...
  <div id="title3" style={{ color: '#fff', fontFamily: 'Inter', fontSize: 26, fontWeight: 700, letterSpacing: '3px', margin: 0, display: 'flex' }}>TECHNICAL ARSENAL</div>
</div>
```
...
<div style={{ width: '100%', height: '100%', background: '#08080c', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative', overflow: 'hidden', borderRadius: 12, border: '1px solid rgba(110,80,220,0.2)' }}>
  ...
  <div id="title4" style={{ color: '#fff', fontFamily: 'Inter', fontSize: 26, fontWeight: 700, letterSpacing: '3px', margin: 0, display: 'flex' }}>EXPERIENCE & JOURNEY</div>
</div>
```
...
<div style={{ width: '100%', height: '100%', background: '#08080c', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative', overflow: 'hidden', borderRadius: 12, border: '1px solid rgba(110,80,220,0.2)' }}>
  ...
  <div id="title5" style={{ color: '#fff', fontFamily: 'Inter', fontSize: 26, fontWeight: 700, letterSpacing: '3px', margin: 0, display: 'flex' }}>GITHUB ANALYTICS</div>
</div>
```
